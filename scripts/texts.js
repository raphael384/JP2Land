var questionsTexts = [
    ...
    "C'est le premier avril, tu trouves une punaise sur ta chaise ...",
    "Tu rêverais d'avoir des élèves ...",
    "Ton cauchemar ...",
    "Ton metier si tu n'etais pas prof : ",
    "La fin de l'année approche",
    "L'alarme retentit en plein cours, c'est un exercice :",
...
var loiratTexts = [
    ...
    "\"Mais quel manque de respect dans une école catholique !!\"",
    "Très disciplinés.",
    "Des élevès rebelles et délinquants.",
    "Boulanger.",
    "On lâche rien, on est là pour travailler jusqu'au bout !",
...
var martineauTexts = [
    ...
    "\"C'est quoi ça ??\", soupires-tu",
    "Sympas mais calmes",
    "Moins de congés",
    "Militaire",
    "Tu glandes déjà depuis un mois",
...
var charetteTexts = [
    ...
    "\"Vous avez la mentalité d'élevès de primaire !\"",
    "Passionés par la matière que tu enseignes.",
    "La matière que tu enseignes disparaît",
    "Moine, bonne soeur.",
    "Nous allons enfin commencer le programme de cette année",
    "<soupir> toujours au mauvais moment ...",
    "Outré, tu informes tes collègues qui emploieront la première proposition."
